...
<p align="left">
<a href="https://github.com/503496348-ops/mindriver/stargazers"><img alt="GitHub stars" src="https://img.shields.io/github/stars/503496348-ops/mindriver?style=social"></a>
<a href="https://github.com/503496348-ops/mindriver/issues"><img alt="GitHub issues" src="https://img.shields.io/github/issues/503496348-ops/mindriver"></a>
<img alt="License" src="https://img.shields.io/github/license/503496348-ops/mindriver">
<a href="https://github.com/503496348-ops/mindriver/actions/workflows/ci.yml"><img alt="CI" src="https://github.com/503496348-ops/mindriver/actions/workflows/ci.yml/badge.svg"></a>
<img alt="Domain" src="https://img.shields.io/badge/domain-%E6%99%BA%E8%83%BD%E4%BD%93%E8%BF%90%E7%BB%B4-blue">
</p>

## Highlights

- **Product**: MindRiver / 智脑星河
- **Domain**: 智能体运维
...
## Agent Fleet Ops Panel

`mindriver/fleet_ops.py` adds a product-native ops panel for agent fleets: it separates live processes from semantic readiness, detects stale event flows, emits token-safe Codex device-auth recovery plans, and audits context nodes for duplicates or empty entries.
...
| **Fleet Ops 面板** | Agent probe + event flow + login recovery + context integrity | 区分“进程活着”和“语义可用” |
